...
pushd "${scriptDir}"
  ...
  runInShell "cabal2nix glibcLocales" "$(nix-build -A stack2nix --no-out-link -Q ../)"/bin/stack2nix --platform x86_64-linux --hackage-snapshot 2018-05-22T09:58:14Z -j8 --test --bench ./.. > default.nix.new
